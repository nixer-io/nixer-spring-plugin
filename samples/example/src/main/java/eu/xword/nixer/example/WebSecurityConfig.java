...
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.Conditions;
...
import static eu.xword.nixer.nixerplugin.core.detection.filter.behavior.Behaviors.BLOCKED_ERROR;
import static eu.xword.nixer.nixerplugin.core.detection.filter.behavior.Behaviors.CAPTCHA;
