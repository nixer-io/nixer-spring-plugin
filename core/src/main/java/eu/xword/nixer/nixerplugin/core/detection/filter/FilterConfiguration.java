package eu.xword.nixer.nixerplugin.core.detection.filter;

import java.util.List;
import java.util.Optional;

import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.Behavior;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.BehaviorEndpoint;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.BehaviorProvider;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.BehaviorProviderBuilder;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.BehaviorRegistry;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.BehaviorsProperties;
import eu.xword.nixer.nixerplugin.core.detection.filter.behavior.LogBehavior;
import eu.xword.nixer.nixerplugin.core.detection.filter.ip.IpMetadataConfiguration;
