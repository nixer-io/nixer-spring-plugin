...
import static eu.xword.nixer.nixerplugin.core.stigma.token.validation.ValidationStatus.EXPIRED;
import static eu.xword.nixer.nixerplugin.core.stigma.token.validation.ValidationStatus.INVALID_PAYLOAD;
import static eu.xword.nixer.nixerplugin.core.stigma.token.validation.ValidationStatus.MISSING_STIGMA;
import static eu.xword.nixer.nixerplugin.core.stigma.token.validation.ValidationStatus.PAYLOAD_PARSING_ERROR;
