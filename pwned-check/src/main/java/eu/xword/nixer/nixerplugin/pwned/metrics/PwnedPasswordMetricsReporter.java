...
import static eu.xword.nixer.nixerplugin.pwned.metrics.PwnedCheckCounters.NOT_PWNED_PASSWORD;
import static eu.xword.nixer.nixerplugin.pwned.metrics.PwnedCheckCounters.PWNED_PASSWORD;
...
public class PwnedPasswordMetricsReporter {
    ...
    public static PwnedPasswordMetricsReporter create(final MetricsFactory metricsFactory) {
        ...
        return new PwnedPasswordMetricsReporter(
                metricsFactory.counter(PWNED_PASSWORD),
                metricsFactory.counter(NOT_PWNED_PASSWORD)
        );
    }
}
